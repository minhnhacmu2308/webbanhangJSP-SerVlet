        ...
        <div class="container">
          <div class="row">
            ...
            <div class="item"><img  src="https://www.thuengay.vn/uploads/770x433/db8e335e4f8e122d3247542967482f123f88882c2.jpg" alt="" class="img-fluid"></div>
             ...
             <div class="item"><img src="<%=request.getContextPath()%>/img/banner10.jpg" alt="Get inspired" class="img-fluid"></a></div>
              </div>
              <!-- /#main-slider-->
            </div>
          </div>
          ...
          <div class="container">
            <div class="product-slider owl-carousel owl-theme">
                ...
                <div class="product">
                  ...
                  </div><a href="detail.jsp" class="invisible"><img src="<%=request.getContextPath()%>/img/<%=newsListProduct.get(j).getProductPicture() %>" alt="" class="img-fluid"></a>
                  <div class="text">
