          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="card card-border-color card-border-color-primary">
                <div class="card-header card-header-divider">Add Blogs <span class="card-subtitle">This is the default bootstrap form layout</span></div>
                <div class="card-body">
                  <form action="addblog" method="post" enctype="multipart/form-data" name="form1" id="form1">
                   
                    <div class="form-group">
                      <label for="inputUserName">Title</label>
                      <input class="form-control" name="title" id="title" type="text"  parsley-trigger="change" required="" placeholder="Title" autocomplete="off">
                    </div>
                    <div class="form-group">
                      <label for="inputUserName">Describe</label>
                      <input class="form-control" name="detail" id="detail" type="text"  parsley-trigger="change" required="" placeholder="Detail" autocomplete="off">
                    </div>
                    <div class="form-group">
                      <label for="inputUserName">Author</label>
                      <input class="form-control" name="author" id="author" type="text"  parsley-trigger="change" required="" placeholder="Author" autocomplete="off">
                    </div>
                    <div class="form-group">
