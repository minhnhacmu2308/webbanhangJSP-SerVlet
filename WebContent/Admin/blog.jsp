        ...
        <div class="main-content container-fluid">
          <div class="row"  id ="deleteBody">
            <div class="col-sm-12">
              ...
              <%List<BlogModel> newsListB= (List<BlogModel>) request.getAttribute("listB"); %>
                <div class="card-body">
                  <table class="table table-striped table-hover table-fw-widget" id="table1">
                    ...
                    <tr class="odd gradeX">
                            <td class="user-avatar cell-detail user-info"><img class="mt-0 mt-md-2 mt-lg-0" src="img/<%=newsListB.get(i).getImage() %>" alt="Avatar">
                            <span> <input style="border-radius: 5px;border-color:#C0C0C0  " id="proName<%=i %>" name="proName" type="text"  value="<%= newsListB.get(i).getTitle() %>" onchange="aa(this,<%=i%>)">  <br>
                           Author: <input id="price<%=i %>" name="price" type="text" style="border-radius: 5px;border-color:#C0C0C0 ;height: 20px;width: 90px;margin-top: 5px" value="<%= newsListB.get(i).getAuthor()%>" onchange="aa(this,<%=i%>)">   
					     <td>
					     <textarea  id="proDes<%=i %>" name="proDes" rows="4" cols="50" onchange="aa(this,<%=i %>)"><%= newsListB.get(i).getDetail()%></textarea>
                           <input type="hidden"  value="" id="proId<%=i %>" >       
                         </td>
                         
                       
                        
                        <td>
                         <a href="deleteblog?idblog=<%=newsListB.get(i).getBlogId() %>" style="color: red" class="btn btn-space btn-outline-danger btn-space"><i style="color: red" class="icon icon-left mdi mdi-alert-circle"></i>Delete</a>
                        </td>
