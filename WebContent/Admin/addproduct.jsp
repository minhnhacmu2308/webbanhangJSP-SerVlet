<%@page contentType="text/html" pageEncoding="UTF-8"%>
 ...
 <%@page import="Dao.impl.CategogyDaoImpl"%>
...
<html lang="en">
  ...
  <body>
   <%
     CategogyDaoImpl a = new CategogyDaoImpl();
          List<CategoryModel> newsListC=  a.getCatPatMore0();%>
  ...
  <div class="toast-body">
   Add product successfully
          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="card card-border-color card-border-color-primary">
                <div class="card-header card-header-divider">Add Product <span class="card-subtitle">This is the default bootstrap form layout</span></div>
                <div class="card-body">
                  <form action="addproduct" method="post" enctype="multipart/form-data" name="form1" id="form1">
                    ...
                    <div class="form-group">
                      ...
                      <input class="form-control" name="nameproduct" id="nameproduct" type="text"  parsley-trigger="change" required="" placeholder="Enter user name" autocomplete="off">
                    </div>
                    <div class="form-group">
                      <label for="inputUserName">Describe</label>
                      <input class="form-control" name="describe" id="describe" type="text"  parsley-trigger="change" required="" placeholder="Enter user name" autocomplete="off">
                    </div>
                    <div class="form-group">
                      <label for="inputUserName">Price</label>
                      <input class="form-control" name="price" id="price" type="text"  parsley-trigger="change" required="" placeholder="Enter user name" autocomplete="off">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <label for="inputUserName">Categeory Parient</label><br>
                       <select name="option" id="option" style="height: 40px" class="form-select form-select-lg mb-3" aria-label=".form-select-lg example">
                   
                    <%for(int i =0 ;i< newsListC.size();i++){ %>
                     <option  value="<%= newsListC.get(i).getCategoryId() %>"><%= newsListC.get(i).getCategoryName() %></option>
                    <%} %>
                    ...
                    <div class="row pt-0 pt-sm-5">
                      ...
                      <div class="col-sm-6 pl-0">
                        <p class="text-right">
                           <input class="btn btn-space btn-primary" type="submit" name="Submit" value="Submit Files">
           ...
           <script type="text/javascript">
                       function addCat(){
                    	   ...
                    	   var file = document.getElementById("file"),formdata = false;
                    	   alert(file);
                    	   var option = document.getElementById("option").value;
                    	
                      	$.ajax({
                      		  url: "/WebsiteBanHang/addproduct",
                      		  type:"post",
                      		  data:{
    ...
    <script src="Admin/assets\lib\parsley\parsley.min.js" type="text/javascript"></script>
    <script type="text/javascript">
      $(document).ready(function(){
