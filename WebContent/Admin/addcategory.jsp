  ...
  <body>
   <%
     CategogyDaoImpl a = new CategogyDaoImpl();
          List<CategoryModel> newsListC=  a.getCatPat0();%>
          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="card card-border-color card-border-color-primary">
                <div class="card-header card-header-divider">Add Category <span class="card-subtitle">This is the default bootstrap form layout</span></div>
                <div class="card-body">
                  <form action="" method="" data-parsley-validate="" novalidate="">
                    <div class="form-group">
                      <label for="inputUserName">Categeory Name</label>
                      <input class="form-control" name="namecategory" id="inputUserName" type="text" name="nick" parsley-trigger="change" required="" placeholder="Enter user name" autocomplete="off">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="row pt-0 pt-sm-5">
                      ...
                      <div class="col-sm-6 pl-0">
                        <p class="text-right">
                          <a class="btn btn-space btn-primary" onclick="addCat()">Submit</a>
           ...
           <script type="text/javascript">
                       function addCat(){
                    	   var namecategory = document.getElementById("inputUserName").value;
                    	   var option = document.getElementById("option").value;
                    	
                      	$.ajax({
                      		  url: "/WebsiteBanHang/addcategory",
                      		  type:"post",
                      		  data:{
