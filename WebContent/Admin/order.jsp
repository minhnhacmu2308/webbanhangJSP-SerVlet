        ...
        <div class="main-content container-fluid">
          <div class="row"  id ="deleteBody">
            <div class="col-sm-12">
              ...
              <%List<OrderModel> newsListB= (List<OrderModel>) request.getAttribute("listO"); %>
                <div class="card-body">
                  <table class="table table-striped table-hover table-fw-widget" id="table1">
                    ...
                    <tr>
                        <td class="user-avatar"> <img src="Admin/assets/img/avatar6.png" alt="Avatar">#<%=newsListB.get(i).getOrderId()  %></td>
                        <td><%=newsListB.get(i).getCreateTime() %></td>
                        <td><%=newsListB.get(i).getTotal() %></td>
                         <% if(newsListB.get(i).getStatus()==false){ %>
                        <td><span class="badge badge-danger"><%= newsListB.get(i).getStatus() %></span></td>
                        <% } else{%>
                        <td><span class="badge badge-success"><%= newsListB.get(i).getStatus() %></span></td>
                        <%} %>
                        <td>
                         <a href="detailorderbyid?id=<%=newsListB.get(i).getOrderId()%>" style="color: green" class="btn btn-space btn-outline-success btn-space"><i style="color: green" class="icon icon-left mdi mdi-alert-circle"></i>View</a>
                          <a href="deleteorder?id=<%=newsListB.get(i).getOrderId()%>" style="color: red" class="btn btn-space btn-outline-danger btn-space"><i style="color: red" class="icon icon-left mdi mdi-alert-circle"></i>Delete</a>
                        </td>
                      </tr>
