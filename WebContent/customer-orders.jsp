              ...
              <div class="box">
                ...
                <div class="table-responsive">
                  <table class="table table-hover">
                    ...
                    <tbody>
                    <% for(int i =0 ;i<newsListOrder.size();i++){ %>
                     <tr>
                        <th>#<%=newsListOrder.get(i).getOrderId()  %></th>
                        <td><%=newsListOrder.get(i).getCreateTime()  %></td>
                        <td><%=newsListOrder.get(i).getTotal() %></td>
                        <% if(newsListOrder.get(i).getStatus()==false){ %>
                        <td><span class="badge badge-danger"><%= newsListOrder.get(i).getStatus() %></span></td>
                        <% } else{%>
                        <td><span class="badge badge-success"><%= newsListOrder.get(i).getStatus() %></span></td>
                        <%} %>
                        
                        <td><a href="<%=request.getContextPath()%>/detailorder?orderId=<%=newsListOrder.get(i).getOrderId()%>" class="btn btn-primary btn-sm">View</a></td>
                      </tr>
                    <%} %>
